...
writeOGR(carteret.shape, file = "./Data/Processed/carteretbytract.shp")
...
please_work <- st_read('./Data/Raw/carteret_tracts.shp')
mapview(please_work)

st_write(please_work, "./Data/Processed/carteret_tracts.shp")
...
data.type <- list("Estimate", "Percent")
...
pov.list <-list("Total Estimate", "Below Poverty Level", "Percent Below Poverty Level")
