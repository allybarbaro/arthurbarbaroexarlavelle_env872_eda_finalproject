...
library(tidyverse);library(lubridate);library(here);library(knitr); library(cowplot); library(readxl)
here()
```
...
carteret.poverty.percent.pivot <- carteret.poverty.percent %>%
  pivot_longer(cols=c("Data Type","Census Tract","Population for Whom Poverty Status is Determined","Under 18 years","18 to 64 years","65 years and over"),
               names_to='Category',
               values_to='Percent of Population') 
```
