...
paletteer_c("ggthemes::Red-Green-Gold Diverging", 30)), layer.name = "Percent of Carteret Below the Poverty Line and Employed", label = carteret.combined.hurricane.shape$NAMELSA)
