...
mapview(carteret.combined.maxflood.shape, zcol = "PpltbPL", col.regions = c(paletteer_d("ggthemes::Nuriel_Stone")), layer.name = "Percent of Carteret County Population Below Poverty Line", label = carteret.combined.maxflood.shape$NAMELSA)
...
carteret.combined.hurricane.shape <- st_read("./Data/Processed/carteret.combined.hurricane.shape.shp")
colnames(carteret.combined.hurricane.shape)


#Population Below Poverty Line Map
mapview(carteret.combined.hurricane.shape, zcol = "PpltbPL", col.regions = c(paletteer_c("grDevices::Zissou 1", 30)), layer.name = "Percent of Carteret County Population Below Poverty Line", label = carteret.combined.hurricane.shape$NAMELSA)
