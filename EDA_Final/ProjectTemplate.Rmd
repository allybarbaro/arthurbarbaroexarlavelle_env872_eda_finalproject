...
- Table 2.1 \@ref(tab:Table2.1): Structure of Demographic Data

- Table 2.2 \@ref(tab:Table2.2): Structure of Flooding and Hurricane Data 

*Analysis*

- Table 4.1.1 \@ref(fig:Figure4.1.1): Results of Annualized Flooding Frequency Correlation Tests

- Table 4.2.1 \@ref(fig:Figure4.2.1): Results of Annualized Hurricane Frequency Correlation Tests
...
```{r Table2.1, fig.cap = "Table 2.1 Structure of Demographic Data", echo=FALSE}
...
```{r Table2.2, fig.cap = "Table 2.2 Structure of Flooding and Hurricane Data", echo=FALSE}
