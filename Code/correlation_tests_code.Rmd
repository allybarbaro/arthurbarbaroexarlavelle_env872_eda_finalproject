...
#write.csv(combined.demographics,
          #file = here("./Data/Processed/combined.demographics.csv"))
...
colnames(carteret.combined.maxflood.shape)
...
```{r Factors & Carteret County Hurricane Correlation}
#loading in required data
...
```{r Significant Factors & Hurricane Maps}
#making spatial
...
mapview(carteret.combined.maxhurricane.shape, zcol = "Undr18b", col.regions = c(paletteer_d("ggthemes::Nuriel_Stone")), layer.name = "Percent of Population Under 18 Below Poverty Line in Max Annualized Hurricane Frequency Census Tracts", label = carteret.combined.maxhurricane.shape$NAMELSA)
