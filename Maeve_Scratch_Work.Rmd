...
mapview(shape.and.race.number, zcol = "Black or African American",
        col.regions = c(paletteer_c("ggthemes::Sunset-Sunrise Diverging", 30)))

#American Indian and Alaska Native number
mapview(shape.and.race.number, zcol = "American Indian and Alaska Native",
        col.regions = c(paletteer_c("ggthemes::Sunset-Sunrise Diverging", 30)))

#Cherokee Tribal Grouping number
mapview(shape.and.race.number, zcol = "Cherokee Tribal Grouping",
        col.regions = c(paletteer_c("ggthemes::Sunset-Sunrise Diverging", 30)))
