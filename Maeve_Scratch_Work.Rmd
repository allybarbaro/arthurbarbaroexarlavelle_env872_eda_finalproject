...
```{r max floding and demographic maps}
...
```
```{r min flooding and demographics map}
#White Population Percent
...
mapview(min_flooding, zcol = "Sioux Tribal Grouping Population Percent",
        col.regions = c(paletteer_c("ggthemes::Sunset-Sunrise Diverging", 30)),
        layer.name = "Sioux Tribal Grouping Percent in Tracts with Lowest Annualized Flooding Frequency")
