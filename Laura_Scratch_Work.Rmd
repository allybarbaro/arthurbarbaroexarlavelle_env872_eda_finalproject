...
Carteret_Flooding <- NC_Hazard %>%
  ...
  select(TRACT, POPULATION, CFLD_EXPPE, CFLD_EXPT, CFLD_RISKV, CFLD_RISKS, CFLD_RISKR)
...
write.csv(Carteret_Flooding, row.names = FALSE, file = "./Data/Processed/Carteret_Hurricanes_Processed.csv")
